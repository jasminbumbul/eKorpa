![Readme Banner](https://i.ibb.co/YXVVTzv/pocetna-rsq1.png)

# eKorpa

### THIS IS A DEMO PROJECT AND IS CURRENTLY IN DEVELOPMENT
...
The current version of the app (1/3 done), can be visited by clicking [on this link](https://www.p2040.app.fit.ba/).

### Item details
![alt text](https://i.ibb.co/7X9JyB0/temp.png)
