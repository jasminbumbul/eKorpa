...
namespace eKorpa.Areas.Identity.Pages.Account
{
    ...
    public class ConfirmPhoneModel : PageModel
    {
        ...
        public ConfirmPhoneModel(UserManager<Korisnik> userManager, IOptions<TwilioVerifySettings> settings)
        {
        ...
        public TwilioVerifySettings Settings => _settings;
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            try
            {
                var verification = await VerificationCheckResource.CreateAsync(
                    ...
                    pathServiceSid: Settings.VerificationServiceSID
                );
